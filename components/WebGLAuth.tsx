...
export default function WebGLAuth_({ onAuthSuccess }: WebGLAuthProps) {
  ...
  const handleTermsScroll = (e: React.UIEvent<HTMLDivElement>) => {
    ...
    // Allow accept once the user has scrolled within 40 px of the bottom
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.overlay}>
        {/* ── Step: Welcome ────────────────────────────────────────────── */}
        {step === "welcome" && (
          <div className={styles.card} key="welcome">
        ...
        {/* ── Step: Sign-in ────────────────────────────────────────────── */}
        {step === "signin" && (
          <div className={styles.card} key="signin">
            ...
            <button className={styles.backLink} onClick={() => setStep("terms")}>
              ← Back
            </button>
          </div>
        )}
